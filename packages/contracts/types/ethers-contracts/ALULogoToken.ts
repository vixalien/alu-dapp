...
export interface ALULogoToken extends BaseContract {
  ...
  ownershipPercentage: TypedContractMethod<[account: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "distributeShares",
  ): TypedContractMethod<[recipient: AddressLike, amount: BigNumberish], [void], "nonpayable">;
  getFunction(nameOrSignature: "name"): TypedContractMethod<[], [string], "view">;
  getFunction(nameOrSignature: "owner"): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "ownershipPercentage",
  ): TypedContractMethod<[account: AddressLike], [bigint], "view">;
