...
export interface ALUAssetRegistryInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "AssetRegistered" | "Transfer",
  ): EventFragment;
  ...
  encodeFunctionData(
    functionFragment: "verifyLogoIntegrity",
...
export interface ALUAssetRegistry extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "verifyLogoIntegrity",
  ): TypedContractMethod<
    [tokenId: BigNumberish, contentHash: BytesLike],
    [[boolean, string] & { valid: boolean; message: string }],
    "view"
  ...
  filters: {
    ...
    "AssetRegistered(uint256,address,bytes32,string)": TypedContractEvent<
      AssetRegisteredEvent.InputTuple,
      AssetRegisteredEvent.OutputTuple,
      AssetRegisteredEvent.OutputObject
    >;
